...
public final class MariadbDatabaseInitializer {
     ...
     */
    public void clean() {
        log.info("[MariadbDatabaseInitializer] clean start: database='{}', user='{}'",
        ...
        try {
            ...
            log.info("[MariadbDatabaseInitializer] clean complete");
        } catch (FlywayException e) {
            throw new DatabaseInitializationException(
                "Failed to clean MariaDB database '" + container.getMainDatabase() + "': " + e.getMessage(), e);
        }
    }
