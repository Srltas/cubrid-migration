...
-- =====================================================================
-- §5.5 e2e_mysql_enum_types  (MySQL extension)
-- Invalid ENUM strings are rejected by 8.0 's strict mode; not seeded.
-- =====================================================================
INSERT INTO e2e_mysql_enum_types (id, status_enum) VALUES
(1, NULL),
(2, 'NEW'),
(3, 'CANCEL'),
(4, 'DONE');
...
-- =====================================================================
-- §5.6 e2e_mysql_set_types and §5.7 e2e_mysql_json_types are anti-coverage
-- (no table, no inserts). See SEED_SPEC §1 / V4__schema_extensions.sql for
-- the rationale.
-- =====================================================================
