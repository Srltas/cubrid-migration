...
-- idxf_e2e_order_upper_status is intentionally absent on MariaDB:
-- MariaDB 11.x rejects the MySQL 8.0.13+ `((expr))` functional-index
-- syntax. MariaDB recommends a virtual GENERATED column + plain index
-- instead, but generated columns are E2E anti-coverage. SEED_SPEC §1
