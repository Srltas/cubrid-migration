...
-- Tibero is Oracle-syntax compatible for these objects (per
-- tibero/SEED_SPEC.md §3, §4.1) so DDL is identical to
-- db/oracle/main_schema/V1__schema_business_tables.sql.
-- ============================================================
...
-- ====== Comments (Oracle SPEC §4.5; Tibero supports same syntax) ==
