-- Representative-row queries for the Tibero → CUBRID migration test.
...
--
-- Tibero TC connects to CUBRID as 'dba' so schema-qualification
-- ("OWNER"."TABLE") is required. Tibero MAIN_SCHEMA / REF_SCHEMA names
-- are preserved as CUBRID owner names by CMT (uppercase).
--
-- Coverage mirrors oracle_to_cubrid.sql except that R_MIN/R_MAX boundary
-- values for numeric_types are conservative per Phase 13.3 (Tibero
-- importer limitation; see docs/seed/tibero/SEED_SPEC.md §0).
